...
btn.onclick = function () {
  let msgColor = displayMessage("This is a warning!!", "warning");
...
function displayMessage(msgText, msgType) {
  ...
  msgPanel.classList.add("msgPanel");
  ...
  let msgPanelColor = window
    .getComputedStyle(msgPanel)
